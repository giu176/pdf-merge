"""Windows tailored GUI for the PDF merge utility."""
...
def _initial_browse_dir() -> Path:
    """Return a sensible starting directory for Windows file dialogs."""
    return Path(os.environ.get("USERPROFILE", Path.home()))


class WindowsPDFMergeApp:
    """Tkinter application mirroring the cross-platform layout for Windows."""
    ...
    def _update_delete_template_state(self, *_: object) -> None:
